 ...
 * they don't have the array strength of having an index, thus i can't access elements 
 *  @ O(1) in linkedList. I have to use a pointer/be guided by pointer called (.next)
 ...
 * And linkedList always start at the head.
 */
